...
const api =
  "https://huxley2.azurewebsites.net" || "https://nextrains2.azurewebsites.net";
...
app.get(
  ...
  (request, response) => {
    ...
    if (timeOffset === "arrivals") {
      const URL = `${api}/arrivals/${request.params.to}/from/${request.params.from}/20?expand=true&timeOffset=0&timeWindow=120`;
      axios
        .get(URL)
      ...
      const URL1 = `${api}/departures/${request.params.from}${to}/20?expand=true&timeOffset=${timeOffset}&timeWindow=120`;
      const URL2 = `${api}/arrivals/${request.params.to}/from/${request.params.from}/20?expand=true&timeOffset=${timeOffset2}&timeWindow=120`;
