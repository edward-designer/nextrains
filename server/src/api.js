...
app.get(
  ...
  (request, response) => {
    ...
    if (timeOffset === "arrivals") {
      const URL = `https://nextrains2.azurewebsites.net/arrivals/${request.params.to}/from/${request.params.from}/20?expand=true&timeOffset=0&timeWindow=120`;
      axios
        .get(URL)
      ...
      const URL1 = `https://nextrains2.azurewebsites.net/departures/${request.params.from}${to}/20?expand=true&timeOffset=${timeOffset}&timeWindow=120`;
      const URL2 = `https://nextrains2.azurewebsites.net/arrivals/${request.params.to}/from/${request.params.from}/20?expand=true&timeOffset=${timeOffset2}&timeWindow=120`;
